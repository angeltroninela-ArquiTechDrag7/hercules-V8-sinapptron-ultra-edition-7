...
solvency_ratio = round((cash / debt) * 100, 2)
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen font-mono p-2 md:p-8 pb-32 animate-fade-in bg-[#050505] text-white">
      ...
      <div className="w-full max-w-6xl border border-gray-900 bg-[#0A0A0A] shadow-[0_0_50px_rgba(0,0,0,0.8)] relative p-6 md:p-12">
        
        {/* CONTROL BAR */}
        <div className="absolute top-0 right-0 flex border-b border-l border-gray-800 z-20">
            <button 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-black/20 border border-gray-800 p-6">
                                ...
                                <div>
                                     ...
                                     <pre className="bg-[#020409] p-3 border border-gray-700 text-[9px] text-[#00E5FF]/80 overflow-x-auto"><code>
                                        {PythonProofCode}
                                     </code></pre>
                                </div>
                            </div>
                    ...
                    <div className="space-y-10">
                        ...
                        <section>
                            ...
                            <div className="bg-[#050505] border border-gray-800 p-8 text-sm text-gray-300 leading-relaxed relative overflow-hidden min-h-[200px]">
                                {/* Decorator */}
